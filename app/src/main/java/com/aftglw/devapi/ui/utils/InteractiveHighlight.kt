...
class InteractiveHighlight(
    ...
    private val positionAnimationSpec = spring(0.5f, 300f, Offset(0.5f, 0.5f))

    private val pressProgressAnimation = Animatable(0f, 0.001f)
    private val positionAnimation = Animatable(Offset.Zero, Offset.VectorConverter, Offset(0.5f, 0.5f))
